...
def get_bot_response(user_response):
  ...
  print("Alrighty, bye!" if user_response=="done"else choice(bot_responses1) if user_response=="dogs" else choice(bot_responses2) if user_response=="cats"else "That wasn't an option")
  return user_response!="done"

print("Welcome to the pet lovers chat bot! Here we like to talk about our pets.")
while get_bot_response(input("Do you like dogs or cats better? ")):continue
